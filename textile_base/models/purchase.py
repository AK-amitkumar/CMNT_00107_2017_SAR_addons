...
sum(nullif(pol.width, 0)) as width,
sum(nullif(pol.grammage, 0)) as grammage,
sum(nullif(pt.gauge, 0)) as gauge,
sum(nullif(pt.thread, 0)) as thread,
sum(nullif(pol.product_qty, 0)) AS qty,
sum(nullif(pol.price_unit, 0)) AS price
